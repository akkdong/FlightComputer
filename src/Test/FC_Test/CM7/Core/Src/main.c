...
/* USER CODE BEGIN PFP */
extern void main_loop_begin(void);
extern void main_loop(void);
extern void main_loop_end(void);
/* USER CODE END PFP */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, EPD_D6_Pin|EPD_D7_Pin|EPD_D0_Pin|EPD_D1_Pin
                          |EPD_D2_Pin|EPD_D3_Pin|EPD_D4_Pin|EPD_D5_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, PWR_EN_BAT__Pin|PWR_EN_PERIPH_Pin|PMIC_VCOM_Pin|PMIC_WAKEUP_Pin
                          |PMIC_PWRUP_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, PWR_LED2_Pin|PWR_LED1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : KEY_ESCAPE_Pin EINK_CMD_Pin RPI_STATUS_Pin KEY_LEFT_Pin
  ...
  /*Configure GPIO pins : IMU_DRDY_Pin IMU_FSYNC_Pin IMU_nINT_Pin USB_OTG_HS_ID_Pin */
  GPIO_InitStruct.Pin = IMU_DRDY_Pin|IMU_FSYNC_Pin|IMU_nINT_Pin|USB_OTG_HS_ID_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : EPD_D6_Pin EPD_D7_Pin EPD_D0_Pin EPD_D1_Pin
                           EPD_D2_Pin EPD_D3_Pin EPD_D4_Pin EPD_D5_Pin */
  GPIO_InitStruct.Pin = EPD_D6_Pin|EPD_D7_Pin|EPD_D0_Pin|EPD_D1_Pin
                          |EPD_D2_Pin|EPD_D3_Pin|EPD_D4_Pin|EPD_D5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PWR_EN_BAT__Pin PWR_EN_PERIPH_Pin PMIC_VCOM_Pin PMIC_WAKEUP_Pin
                           PMIC_PWRUP_Pin PWR_LED2_Pin PWR_LED1_Pin */
  GPIO_InitStruct.Pin = PWR_EN_BAT__Pin|PWR_EN_PERIPH_Pin|PMIC_VCOM_Pin|PMIC_WAKEUP_Pin
                          |PMIC_PWRUP_Pin|PWR_LED2_Pin|PWR_LED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : PWR_5V_EN_Pin */
